...
const Main = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-4.5rem)] px-10 md:px-20 bg-white flex items-center">
              ...
              notices.map((item) => (
                ...
                >
                  ...
                  <div className="absolute bottom-8 left-8 text-white">
                    <h3 className="text-2xl font-black mb-2 uppercase tracking-tighter">Vision</h3>
      ...
      {/* === 4. 조합활동 (이미지 좌측 전체) === */}
      <section className="min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-4.5rem)] bg-gray-100 flex flex-col md:flex-row items-stretch">
        {/* 이미지: 화면 절반 전체 차지 */}
